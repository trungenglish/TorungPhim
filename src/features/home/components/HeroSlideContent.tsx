            ...
            <div className="relative flex items-end cursor-grab w-full max-w-[1900px] h-[calc(100%-100px)] my-0 mx-auto overflow-hidden z-[2]">
                <div className="relative z-[5] w-full animate-slide-content pt-0 px-[30px] pb-[60px] max-w-[600px]">
                    ...
                    <div className="flex items-center justify-start flex-wrap gap-[0.6rem] mb-3">
                        <div
                            className="inline-flex items-center bg-transparent border border-solid border-yellow-300 text-white text-xs leading-6 font-medium px-[0.4rem] py-0 rounded-[0.33rem] shrink-0 relative before:content-['IMDb'] before:text-[#f0d25c] before:font-medium before:pr-1 before:text-[10px] before:leading-none"
                        >
                    ...
                    <div className="flex items-center justify-start flex-wrap gap-[0.6rem] mb-6">
                        {[movie.type, movie.type, movie.type, movie.type, movie.type].map((t, idx) => (
                            <Link
                                href="/"
                                key={idx}
                                className="inline-flex items-center bg-[#ffffff10] h-[26px] py-0 px-[0.4rem] text-white text-xs rounded-[0.33rem]"
                            >
                                {t}
                            </Link>
                        ))}
